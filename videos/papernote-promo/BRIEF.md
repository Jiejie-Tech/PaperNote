...
narration: "no"
style_preset: "clean editorial product"
---
...
- `assets/images/library.png` — PaperNote 本地资料库真实截图，用于资料库场景。
- `assets/images/editor.png` — PaperNote 编辑器真实截图，用于手写、分页和 PDF 批注场景。
- `assets/images/social-preview.png` — 统一品牌封面，用于结尾行动场景。

## Customizations

- 采用 PaperNote 现有深青绿、薄荷绿和纸白配色。
- 画面以真实产品截图为主要证据，辅以简洁图形、墨迹线条和字幕。
- 输出 1920×1080 MP4，并从视频生成适合 README 的短 GIF。
