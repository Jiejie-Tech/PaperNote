...
$sourceAssertions=@(
  ...
  @{Path='src\PaperNote.Core\Services\StudyAssistService.cs';Pattern='CreateTape';Label='shared study tape'},
  @{Path='src\PaperNote.Core\Services\StudyAssistService.cs';Pattern='FindAudioForStroke';Label='stroke-to-audio lookup'},
  @{Path='src\PaperNote.Mobile\Pages\EditorPage.StudyAssist.cs';Pattern='ShowStudyAssistAsync';Label='Android classroom tools'},
  @{Path='src\PaperNote.Mobile\Pages\EditorPage.StudyAssist.cs';Pattern='InkCanvasTool.Laser';Label='Android laser tool selection'},
  @{Path='src\PaperNote.Mobile\Pages\EditorPage.cs';Pattern='课堂与复习工具';Label='Android classroom tools entry'},
  @{Path='src\PaperNote.Mobile\Pages\EditorPage.cs';Pattern='跳到关联录音';Label='Android stroke audio jump entry'},
  @{Path='src\PaperNote.Mobile\Platforms\Android\NativeInkCanvasView.cs';Pattern='DrawLaserPointer';Label='Android transient laser renderer'},
